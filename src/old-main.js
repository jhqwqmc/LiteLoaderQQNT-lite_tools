 ...
 * 配置管理模块
 */
const Opt = require("./cjs_modules/option");
/**
 * 本地表情默认配置
 */
 ...
 * 合并配置模块
 */
const loadOptions = require("./cjs_modules/loadOptions");
/**
 * 可控数量Map模块
 */
const LimitedMap = require("./cjs_modules/LimitedMap");
/**
 * 撤回消息加载模块
 */
const MessageRecallList = require("./cjs_modules/MessageRecallList");
/**
 * 全局广播模块
 */
const globalBroadcast = require("./cjs_modules/globalBroadcast");
/**
 * 图片处理模块
 */
const processPic = require("./cjs_modules/processPic");
/**
 * 重写卡片模块
 */
const replaceArk = require("./cjs_modules/replaceArk");
/**
 * 防抖模块
 */
const debounce = require("./cjs_modules/debounce");
/**
 * 视频背景模块
 */
const RangesServer = require("./cjs_modules/rangesServer");
/**
 * 视频服务实例
 */
 ...
 * 日志模块
 */
const logs = require("./cjs_modules/logs");
/**
 * 获取系统字体
 */
const { winGetFonts, linuxGetFonts, macGetFonts } = require("./cjs_modules/getFonts");
/**
 * 本地表情模块
 */
const { loadEmoticons, onUpdateEmoticons } = require("./cjs_modules/localEmoticons");
 ...
 * 渲染进程 hookVue3 模块
 */
let hookVue3 = fs.readFileSync(path.join(LiteLoader.plugins.lite_tools.path.plugin, "src/es_modules/hookVue3.js"), "utf-8");
